...
static void syu645b_set_equalizer(FAR struct syu645b_dev_s *priv, uint32_t preset)
{
	...
	switch(preset) {
	case 0x40000001 :
		syu645b_exec_i2c_script(priv, t_codec_dq_preset_dw9000_script, sizeof(t_codec_dq_preset_dw9000_script) / sizeof(t_codec_init_script_entry));
		priv->max_volume = 0xFF;
		break;
	case 0x40000002 :
		syu645b_exec_i2c_script(priv, t_codec_dq_preset_dw8000_script, sizeof(t_codec_dq_preset_dw8000_script) / sizeof(t_codec_init_script_entry));
		priv->max_volume = 0xFF;
		break;
	case 1 :
		syu645b_exec_i2c_script(priv, t_codec_dq_preset_1_script, sizeof(t_codec_dq_preset_1_script) / sizeof(t_codec_init_script_entry));
		priv->max_volume = 0xFF;
		break;
	case 2 :
		syu645b_exec_i2c_script(priv, t_codec_dq_preset_2_script, sizeof(t_codec_dq_preset_2_script) / sizeof(t_codec_init_script_entry));
		priv->max_volume = 0xE7;
		break;
	default :
		break;
	}
